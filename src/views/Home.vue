  ...
  <div class="mt-6">
   ...
   <div class="max-w-6xl m-auto text-gray-800 flex flex-wrap justify-center">
      <div class="p-5 w-48 ">
         ...
         <a class="my-3 block" href="/#">lorem <span class="text-teal-600 text-xs p-1"></span>
         </a><a class="my-3 block" href="/#">lorem <span class="text-teal-600 text-xs p-1"></span>
         </a><a class="my-3 block" href="/#">lorem  <span class="text-teal-600 text-xs p-1"></span>
         </a><a class="my-3 block" href="/#">lorem <span class="text-teal-600 text-xs p-1"></span>
         </a><a class="my-3 block" href="/#">lorem <span class="text-teal-600 text-xs p-1"></span>
         </a> 
      ...
      <div class="p-5 w-48 ">
         ...
         <a class="my-3 block" href="/#">Oaxaca centro lorem 400  <span class="text-teal-600 text-xs p-1"></span>
         </a><a class="my-3 block" href="/#">lorem@company.com <span class="text-teal-600 text-xs p-1"></span>
         </a> 
      </div>
   </div>
</div>
...
<div class="bg-gray-100 pt-2 ">
   <div class="flex pb-5 px-3 m-auto pt-5 border-t text-gray-800 text-sm flex-col
      ...
      <div class="mt-2">© Copyright 2021. Angel isai web demo</div>
